var MetaMaskOnboarding = function() {
    ...
    ***************************************************************************** */ function __awaiter(thisArg, _arguments, P, generator) {
       ...
       */ /* eslint consistent-return: 1 */ static compareVersions(versionA, versionB, isLoose = false) {
            ...
            while(precision >= lastPrecision){
                ...
                if (chunks[0][precision] === chunks[1][precision]) {
                    if (precision === lastPrecision) // all version chunks are same
                    return 0;
                    precision -= 1;
     ...
     */ class Parser {
       ...
       */ parseBrowser() {
            ...
            const browserDescriptor = Utils.find(browsersList, (_browser)=>{
                ...
                if (_browser.test instanceof Array) return _browser.test.some((condition)=>this.test(condition));
                throw new Error("Browser's test function is not valid");
            });
            if (browserDescriptor) this.parsedResult.browser = browserDescriptor.describe(this.getUA());
       ...
       */ parseOS() {
            ...
            const os = Utils.find(osParsersList, (_os)=>{
                ...
                if (_os.test instanceof Array) return _os.test.some((condition)=>this.test(condition));
                throw new Error("Browser's test function is not valid");
            });
       ...
       */ parsePlatform() {
            ...
            const platform = Utils.find(platformParsersList, (_platform)=>{
                ...
                if (_platform.test instanceof Array) return _platform.test.some((condition)=>this.test(condition));
                throw new Error("Browser's test function is not valid");
            });
       ...
       */ parseEngine() {
            ...
            const engine = Utils.find(enginesParsersList, (_engine)=>{
                ...
                if (_engine.test instanceof Array) return _engine.test.some((condition)=>this.test(condition));
                throw new Error("Browser's test function is not valid");
            });
       ...
       */ isBrowser(browserName, includingAlias = false) {
        ...
        compareVersion(version) {
            ...
            if (typeof currentBrowserVersion !== "string") return void 0;
    ...
    var Onboarding1 = /** @class */ function() {
...
//# sourceMappingURL=index.ec22cbdc.js.map
